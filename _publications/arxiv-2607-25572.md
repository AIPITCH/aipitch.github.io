...
summary: A reproducible classifier for mapping CVEs to MITRE ATT&CK Enterprise techniques, with an evaluation of the limits of LLM-assisted label expansion.
authors:
  - Cédric Bonhomme
  - Alexandre Dulaunoy
member: CIRCL
...
[Cédric Bonhomme](https://arxiv.org/search/cs?searchtype=author&query=Bonhomme%2C+C) and [Alexandre Dulaunoy](https://arxiv.org/search/cs?searchtype=author&query=Dulaunoy%2C+A)
...
Bonhomme, Cédric, and Alexandre Dulaunoy. “Mapping CVEs to MITRE ATT&CK Techniques: A Curated Gold-Set Classifier and the Limits of LLM-Assisted Label Expansion.” *arXiv* 2607.25572 (2026). [https://doi.org/10.48550/arXiv.2607.25572](https://doi.org/10.48550/arXiv.2607.25572).
